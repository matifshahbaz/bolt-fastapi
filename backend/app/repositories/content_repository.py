    ...
    def __init__(self) -> None:
        ...
        self._articles = [
            ...
            ArticleDetail(
                ...
                excerpt="پاکستانی نوجوانوں کے لیے ابھرتے ہوئے شعبوں، مہارتوں، اور صحیح فیصلے کے عملی نکات پر مبنی رہنمائی۔",
                ...
                published_at="15 جنوری 2025",
                reading_time="8 منٹ",
                content=[
                    ArticleSection(type="heading", text="تعارف"),
                    ArticleSection(type="paragraph", text="صحیح کیریئر کا انتخاب نوجوانوں کی زندگی کا اہم ترین فیصلہ ہے اور اس کے لیے واضح رہنمائی ضروری ہے۔"),
                    ArticleSection(type="heading", text="ابھرتے ہوئے شعبے"),
                    ArticleSection(type="paragraph", text="ڈیجیٹل مارکیٹنگ، ڈیٹا، تعلیم، صحت، اور چھوٹے کاروبار پاکستان میں تیزی سے بڑھتے ہوئے شعبے ہیں۔"),
                ],
            ),
            ArticleDetail(
                id="2",
