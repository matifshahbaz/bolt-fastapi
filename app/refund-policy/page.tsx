...
export const metadata: Metadata = {
  title: 'ریفنڈ پالیسی',
  description: 'shama.pk کورس خریداری کے لیے 30 دن کی ریفنڈ پالیسی، اہلیت اور درخواست کا طریقہ۔',
  alternates: {
      ...
      <section className="bg-gradient-to-b from-primary/5 to-background py-16">
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-nastaliq text-foreground leading-[1.7]">
            30 دن میں مکمل ریفنڈ، بغیر کسی سوال کے
          </h1>
          <p className="mt-4 text-lg text-muted-foreground font-nastaliq leading-[1.9]">
            shama.pk پر خریدے گئے بامعاوضہ ڈیجیٹل کورسز کے لیے صارف خریداری کے 30 دن کے اندر مکمل ریفنڈ لے سکتا ہے۔
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border bg-card p-7 space-y-5">
            ...
            <ul className="list-disc space-y-2 pr-6 text-base text-muted-foreground font-nastaliq leading-[1.9]">
              <li>ریفنڈ خریداری کی تاریخ سے 30 دن کے اندر دستیاب ہے۔</li>
              <li>30 دن کے بعد ریفنڈ کی درخواست قبول نہیں کی جائے گی۔</li>
            ...
            <ol className="list-decimal space-y-2 pr-6 text-base text-muted-foreground font-nastaliq leading-[1.9]">
              ...
              <li>اگر خریداری 30 دن کے اندر ہو تو ریفنڈ فوراً پراسیس ہو جائے گا۔</li>
            </ol>
          </div>
        </div>
      </section>
