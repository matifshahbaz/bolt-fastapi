        ...
        <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="rounded-2xl border bg-card p-6">
            ...
            <div className="space-y-3 text-base text-muted-foreground leading-relaxed font-nastaliq">
              ...
              <p>
                ہم Google Analytics کے ذریعے صفحات کے وزٹس، ریفرل سورس، ڈیوائس کی قسم، عمومی جغرافیائی معلومات،
                اور سائٹ پر صارف کی سرگرمی جیسے استعمالی اعداد و شمار جمع کر سکتے ہیں تاکہ ویب سائٹ اور مواد کو
                بہتر بنایا جا سکے۔ Google Analytics یہ معلومات کوکیز اور اسی نوعیت کی ٹیکنالوجیز کے ذریعے پراسیس
                کر سکتا ہے۔
              </p>
              <p>
